...
- The map is hosted by GitHub and can be found at https://kirstkennedy.github.io/leaflet-storymaps-with-google-sheets/
- Google Sheets template https://docs.google.com/spreadsheets/d/1l5FZBVKjzMikHYxX__YEalutJQ9LRvgcWqXBLRKyIrU/edit#gid=0
